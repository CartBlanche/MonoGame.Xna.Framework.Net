...
{
    /// <summary>
    /// Leaderboard provider for Android backend.
    /// Uses a process-local shared table as the initial vertical slice until platform SDK calls are wired.
    /// </summary>
    public sealed class AndroidLeaderboardProvider : ILeaderboardProvider
    {
