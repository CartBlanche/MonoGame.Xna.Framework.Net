...
{
    /// <summary>
    /// Leaderboard provider for EOS backend.
    /// Uses process-local shared state with optional EOS submission/reads.
    /// </summary>
    public sealed class EOSLeaderboardProvider : ILeaderboardProvider
    {
