...
{
    /// <summary>
    /// Achievement provider for EOS backend.
    /// Uses process-local shared state with optional EOS projection.
    /// </summary>
    public sealed class EOSAchievementProvider : IAchievementProvider
    {
        ...
        public async Task<AchievementCollection> GetAchievementsAsync(SignedInGamer gamer, CancellationToken cancellationToken = default)
        {
            ...
            IReadOnlyDictionary<string, EpicAchievementProgress> liveProgress = null;
